...
def build_configuration_schema(block_key, properties):
    """
    ...
    ----------
    block_key : str
        The BLOCK key (e.g. BLOCK-T000) to include in the title and description.
    properties : dict
    ...
    configuration_schema = (
        ...
        f"title: {block_key} configuration\n"
        f"description: Configuration for {block_key}.\n"
        "type: object\n"
        "properties:\n"
    )
